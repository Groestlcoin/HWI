...
class TrezorClient(HardwareWalletClient):
    ...
    def sign_tx(self, tx: PSBT) -> PSBT:
        ...
        master_key = btc.get_public_node(self.client, [0x80000000], coin_name='Groestlcoin')
        ...
        while p < passes:
            ...
            for input_num, (psbt_in, txin) in py_enumerate(list(zip(tx.inputs, tx.tx.vin))):
                ...
                def ignore_input() -> None:
                    txinputtype.address_n = [0x80000000 | 84, 0x80000000 | (17 if self.chain == Chain.MAIN else 1), 0x80000000, 0, 0]
    ...
    def can_sign_taproot(self) -> bool:
        """
        Trezor T supports Taproot in firmware versions greater than (not including) 2.4.3.
        Trezor One supports Taproot in firmware versions greater than (not including) 1.10.4.
